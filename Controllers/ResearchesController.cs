...
namespace ArchiveHist.Controllers
{
    public class ResearchesController : Controller
    {
        ...
        public ResearchesController(ArchiveHistContext context)
        {
            _context = context;
        }
        ...
        {
            var archiveHistContext = _context.Researches.Include(r => r.CIdNavigation);
        ...
        public async Task<IActionResult> DeleteConfirmed(int id)
        {
            ...
            {
                return Problem("Entity set 'ArchiveHistContext.Researches'  is null.");
            }
            var research = await _context.Researches.FindAsync(id);
            if (research != null)
            {
        ...
        {
          return (_context.Researches?.Any(e => e.RId == id)).GetValueOrDefault();
        }
    }
}
