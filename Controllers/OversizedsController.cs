...
namespace ArchiveHist.Controllers
{
    public class OversizedsController : Controller
    {
        ...
        public OversizedsController(ArchiveHistContext context)
        {
            _context = context;
        }
        ...
        {
            var archiveHistContext = _context.Oversizeds.Include(o => o.CIdNavigation);
        ...
        {
            if (id == null || _context.Oversizeds == null)
            {
                return NotFound();
            }
        ...
        {
            if (_context.Oversizeds == null)
            {
                return Problem("Entity set 'ArchiveHistContext.Oversizeds'  is null.");
            }
            var oversized = await _context.Oversizeds.FindAsync(id);
            if (oversized != null)
            {
        ...
        {
          return (_context.Oversizeds?.Any(e => e.OId == id)).GetValueOrDefault();
        }
    }
}
