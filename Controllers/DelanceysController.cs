...
namespace ArchiveHist.Controllers
{
    public class DelanceysController : Controller
    {
        ...
        public DelanceysController(ArchiveHistContext context)
        {
            _context = context;
        }
        ...
        {
            var archiveHistContext = _context.Delanceys.Include(d => d.CIdNavigation);
        ...
        {
            if (id == null || _context.Delanceys == null)
            {
                return NotFound();
            }
        ...
        {
            if (_context.Delanceys == null)
            {
                return Problem("Entity set 'ArchiveHistContext.Delanceys'  is null.");
            }
            var delancey = await _context.Delanceys.FindAsync(id);
            if (delancey != null)
            {
        ...
        {
          return (_context.Delanceys?.Any(e => e.DId == id)).GetValueOrDefault();
        }
    }
}
